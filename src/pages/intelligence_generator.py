...
READING_SHELL = '''
    <header class="reading-header">
      ...
      <nav class="reading-nav" aria-label="簡報導覽"><a href="#market-direction">市場方向</a><a href="#reading-stories">市場重點</a><a href="#reading-watch">接下來要留意</a><a href="#technical-report">查看證據</a></nav>
    </header>
    ...
    <section class="market-direction" id="market-direction" aria-labelledby="market-direction-title">
      <div class="market-direction-heading">
        <h2 id="market-direction-title">今日市場方向</h2>
        <p>根據目前可用市場資料整理，只描述價格方向，不構成買賣建議。</p>
      </div>
      <div id="market-direction-content" class="market-direction-groups" aria-live="polite" aria-busy="true"><p>正在讀取市場方向。</p></div>
    </section>
    ...
    <section class="reading-section crypto-sentiment" id="crypto-sentiment" aria-labelledby="crypto-sentiment-title">
      <h2 id="crypto-sentiment-title">Crypto 資金情緒</h2>
      <div class="crypto-sentiment-placeholder">
        <p class="placeholder-status">資料尚未接入</p>
        <p>未來將觀察：</p>
        <ul><li>資金費率（Funding Rate）</li><li>未平倉量（OI）</li><li>槓桿變化</li></ul>
        <p class="reading-footnote">目前不顯示任何即時或模擬數值，亦未用於情報判斷。</p>
      </div>
    </section>
'''
...
READING_STYLES = '''
    ...
    .market-direction { border-top: 1px solid var(--line); padding: 26px 0 30px; }
    .market-direction-heading { display: flex; align-items: baseline; justify-content: space-between; gap: 20px; margin-bottom: 16px; }
    .market-direction-heading h2 { font-size: 1.15rem; margin: 0; }
    .market-direction-heading p { color: var(--muted); font-size: .78rem; margin: 0; text-align: right; }
    .market-direction-groups { display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); gap: 10px; }
    .market-direction-groups[aria-busy="true"] { min-height: 118px; }
    .direction-group { background: rgba(16, 35, 47, .6); border: 1px solid var(--line); border-radius: 12px; padding: 12px; min-width: 0; }
    .direction-group h3 { color: var(--muted); font-size: .67rem; font-weight: 500; letter-spacing: .08em; margin: 0 0 10px; text-transform: uppercase; }
    .direction-item { align-items: center; display: grid; gap: 0 8px; grid-template-columns: 24px minmax(0, 1fr); margin-top: 9px; min-width: 0; }
    .direction-item:first-of-type { margin-top: 0; }
    .direction-icon { font-size: 1rem; grid-row: 1 / span 2; text-align: center; }
    .direction-asset { font-size: .78rem; line-height: 1.25; overflow-wrap: anywhere; }
    .direction-state { font-size: .92rem; font-weight: 650; line-height: 1.35; }
    .direction-up .direction-state { color: #69d8bf; }
    .direction-down .direction-state { color: #ffb985; }
    .direction-flat .direction-state, .direction-attention .direction-state { color: var(--muted); }
    .crypto-sentiment-placeholder { background: rgba(16, 35, 47, .45); border: 1px dashed var(--line); border-radius: 12px; padding: 18px 20px; }
    .crypto-sentiment-placeholder p { margin: 0 0 10px; }
    .crypto-sentiment-placeholder ul { margin: 8px 0 14px; padding-left: 22px; }
    .placeholder-status { color: var(--muted); font-weight: 650; }
    ...
    @media (max-width: 560px) {
      ...
      .market-direction { padding-top: 22px; }
      .market-direction-heading { align-items: flex-start; display: block; }
      .market-direction-heading p { margin-top: 8px; text-align: left; }
      .market-direction-groups { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px; }
      .direction-group { padding: 11px; }
